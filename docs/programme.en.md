...
| 23 | [Evaluating agents](modules/23-evaluating-agents.md) | Eval as a test, a golden set, regression as the difference between runs | 1 wk |
...
| 26 | [Reproduction](modules/26-reproduction.md) | From a paper to working code: what the paper left out, how to ask the authors, what counts as success | 2 wk |
| 27 | [How to keep up with the field](modules/27-how-to-keep-up.md) | The practice of reading: sources, filters, notes, how not to drown in the stream and not fall behind | 1 wk |
