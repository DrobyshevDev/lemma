...
| 3 | Линейная алгебра как язык | Вектор, матрица, произведение как преобразование, проекция, собственные числа. Всё — через регрессию и PCA, без абстрактных упражнений | 2 нед. |
| 4 | Производные и оптимизация | Производная, градиент, цепное правило, градиентный спуск. Пишем SGD с нуля и смотрим, где он ломается | 2 нед. |
