...
| 2 | Данные и вероятность | Случайная величина, распределение, условная вероятность, теорема Байеса, оценка параметра. Переобучение как явление, а не как термин | 2 нед. |
