...
Из страницы любого модуля — ссылкой **«открыть в Colab»** рядом с ноутбуком. Ставить
нечего: код курса импортирует только NumPy и Matplotlib, а они в Colab уже есть.
Читатель, которому интересен один модуль, не должен ради него заводить окружение.

Локально, если хочется держать всё у себя:
...
Все двадцать семь модулей готовы — обе языковые версии, ноутбук к каждому,
CI зелёный. Курс можно проходить целиком, от первого модуля до выпускной работы.
...
| VI. Агенты | 21–23 | **готова целиком** |
| VII. Выход на фронтир | 24–27 | **готова целиком** |
